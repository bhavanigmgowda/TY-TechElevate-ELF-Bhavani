            ...
            <div className="col-md-12 ">
                <div className="row">
                              ...
                              {/*  */}           <div class="col-md-4 col-sm-12" id="todo" onDragOver={(e) => this.onDragOver(e, "todo")} >
                                            ...
                                            {/*End of  ToDo */}
                                            {/* onProgress */}
                                            <div className="col-md-4 col-sm-12" id="onProgress" onDragOver={(e) => this.onDragOver(e, "onProgress")}>
                                                <div className="card">
                                                <div className="card-header header">
                                            ...
                                            <div className="col-md-4 col-sm-12" id="blocked" onDragOver={(e) => this.onDragOver(e, "blocked")}>
                                                <div className="card">
                                                <div className="card-header header">
...
<TaskInfo  taskBean={this.state.taskBean} user={this.state.user}  getComment={()=>this.getCommentData()}close={()=>this.setState({showData:false})} showUpadtaed={()=>this.getData()} comment={this.getCommentData.bind()} commentBean={this.state.commentBean}  />
 </div>
:null}
                            </div>
</div>
