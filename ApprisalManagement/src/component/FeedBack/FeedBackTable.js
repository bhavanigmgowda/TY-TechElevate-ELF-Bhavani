...
<Card>
 ...
 <table class="table table-hover " >
      ...
      <center>
          <Button style={{width:"10%",backgroundColor:"mediumaquamarine" ,border:"none"}} align="center"> Add Comment </Button>&nbsp;&nbsp;&nbsp;
      <Button style={{width:"10%",backgroundColor:"lightgreen",border:"none"}} align="center">Submit</Button></center> 
