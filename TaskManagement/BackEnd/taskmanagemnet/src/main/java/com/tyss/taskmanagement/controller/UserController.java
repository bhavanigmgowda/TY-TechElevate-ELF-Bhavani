...
import com.tyss.taskmanagement.service.UserService;
...
public class UserController {
	...
	public Response login(@RequestParam("email") String email, @RequestParam("password") String password,HttpServletRequest request) {
		return service.login(email, password,request);
	}// End of login()
