...
export class Offer2 extends Component {
    ...
    render() {
        ...
        return (
            <div id="qwerty">
                <Home pdf={this.get} buttonShow={true} showWatermark={(data) => this.setState({ waterMark: data })} sendData={() => this.sendData()} />
                <div className="main">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style={{ textAlign: 'left' }} width={300}>
                                                ...
                                                <p style={{ paddingLeft: 10, margin: 0 }}>i) Aadhar  Copy</p>
