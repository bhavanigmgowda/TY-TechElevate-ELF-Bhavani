        ...
        return (
            <div class=" card-body  h-75">
                <div className="input-group mb-3 option">
                    ...
                    {this.state.edit ? <div><div className="input-group mb-2">
                        <textarea style={{ color: 'black' }} type="text" className="form-control" placeholder="Add a Comment"
                            ...
                            {this.state.comment ? <><Button onClick={() => this.addComment()} >save</Button> <Button onClick={() => this.close()} >Cancel</Button></>
                            : <Button onClick={() => this.close()} >Close</Button>} 
                             </div> :
                        <div>


                            <Button onClick={() => this.addComment()} >save</Button> <Button onClick={() => this.close()} >Cancel</Button>
                        </div>
                    }
                </div>
            </div>
