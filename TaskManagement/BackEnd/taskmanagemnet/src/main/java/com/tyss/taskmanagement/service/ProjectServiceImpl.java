...
public class ProjectServiceImpl implements ProjectService {
	...
	public Response getProject(int projectId) {
		...
		try {
			if (projectId != 0) {
				response=ResponseContainerutil.fillerSuccess("project find successfully");
	...
	public Response getAllMembers(int groupId) {
		...
		try {
			if (repository.findProjectById(groupId) >= 1) {
				...
				response=ResponseContainerutil.fillerSuccess("members found successfully by id");
	...
	public Response getProject(int projectId, String email) {
		...
		if (projectId != 0 && userRepository.getUserBean(email).isPresent()) {
			response=ResponseContainerutil.fillerSuccess("project found successfully by mail");
