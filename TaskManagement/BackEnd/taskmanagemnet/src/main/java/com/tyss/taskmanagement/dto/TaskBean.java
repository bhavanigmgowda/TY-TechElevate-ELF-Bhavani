...
public class TaskBean implements Serializable, Comparable<TaskBean> {
	...
	@ManyToOne
	@JoinColumns({
			@JoinColumn(name = "project_id", referencedColumnName = "project_id", insertable = true, updatable = true),
			@JoinColumn(name = "e_id", referencedColumnName = "emp_id", insertable = true, updatable = true) })
